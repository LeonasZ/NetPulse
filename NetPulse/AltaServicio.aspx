...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row row-cols-lg-auto g-3 align-items-center" style="margin: 40px 20px">
        ...
        <asp:Label Style="color: darkgray" ID="Label2" runat="server" Text="Disponibilidad..."></asp:Label>
            ...
            <asp:Button Style="margin: 40px 20px; display: block; margin-bottom: 20px" ID="btnAgregarPlan" runat="server" Text="AgregarPlan" type="submit" class="btn btn-primary" OnClick="btnReincorporar_Click" />

            <asp:Button Style="margin: 40px 20px; display: block; margin-bottom: 20px" ID="btnAgregarDomicilio" runat="server" Text="AgregarDomicilio" type="submit" class="btn btn-primary" OnClick="btnReincorporar_Click" />
            </div>
